...
def train_category_model():
    ...
    print("Training XGBoost category classifier...")
    ...
    print("\n" + "=" * 55)
    print("CAMPUSFIX AI - CATEGORY CLASSIFIER")
    print("=" * 55)
    ...
    print("\nSaved:")
    print("✓ models/category_xgboost.pkl")
    print("✓ models/category_tfidf.pkl")
    print("✓ models/category_labels.pkl")
